...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-166,-109), S(-105,-76), S(-75,-49), S(-80,-22) },
   { S( -72, -75), S( -44,-62), S(-20, -8), S( -9,  0) },
   { S( -61, -33), S( -21,-26), S(  6,-12), S( 18, 28) },
   { S( -39, -39), S(  15,-14), S( 31,  4), S( 44, 40) },
   { S( -26, -40), S(  14,-20), S( 42,  9), S( 54, 36) },
   { S( -16, -49), S(  26,-44), S( 61,-14), S( 62, 13) },
   { S( -69, -70), S( -20,-43), S(  4,-37), S( 28, 16) },
   { S(-205,-101), S( -78,-97), S(-49,-50), S(-31,-27) }
  },
  { // Bishop
