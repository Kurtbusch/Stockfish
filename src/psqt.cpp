...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(272,    0), S(325,    0), S(273,    0), S(190,    0) },
   { S(277,   0), S(305,  200), S(241,   250), S(183,   300) },
   { S(198, 250), S(253,450), S(168, 500), S(120, 550) },
   { S(169,500), S(191,700), S(136,750), S(108,800) },
   { S(145,750), S(176,950), S(112,1000), S(69,1050) },
   { S(122,1000), S(159,1200), S(85,1250), S(36,1300) },
   { S(87,1250), S(120,1450), S(64,1500), S(25,1550) },
   { S(64,20000), S(87,20000), S(49,20000), S(0,20000) }
  }
};
