...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-172,-104), S(-97,-70), S(-81,-47), S(-83,-20) },
   { S( -78, -71), S(-36,-58), S(-25,-14), S( -8,  4) },
   { S( -61, -32), S(-18,-30), S(  6, -3), S( 24, 26) },
   { S( -32, -31), S(  3, -8), S( 39, 21), S( 47, 29) },
   { S( -39, -38), S( 12,-17), S( 45,  5), S( 54, 33) },
   { S( -13, -50), S( 23,-39), S( 67,-22), S( 50, 15) },
   { S( -70, -63), S(-23,-42), S(  6,-39), S( 48, 18) },
   { S(-203, -92), S(-87,-88), S(-59,-55), S(-34,-20) }
  },
  { // Bishop
