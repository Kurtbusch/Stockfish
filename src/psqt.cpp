...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-163,-113), S(-114, -78), S(-70,-53), S(-81,-26) },
   { S( -65, -81), S( -49, -67), S(-17, -1), S( -9, -7) },
   { S( -57, -29), S( -22, -20), S(  9,-20), S( 18, 28) },
   { S( -51, -41), S(  26, -27), S( 21, -4), S( 42, 46) },
   { S( -24, -38), S(  16, -21), S( 41, 14), S( 55, 36) },
   { S( -21, -47), S(  24, -50), S( 59,-11), S( 69,  7) },
   { S( -72, -76), S( -19, -40), S(  1,-38), S( 19, 17) },
   { S(-210,-103), S( -77,-105), S(-45,-48), S(-30,-37) }
  },
  { // Bishop
