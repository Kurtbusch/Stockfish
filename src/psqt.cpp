...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(272,  0), S(325, 41), S(291, 80), S(190, 93) },
...
void init() {
  ...
  psq[W_PAWN][SQ_A6]   += make_score(-19, 0);
  psq[W_KING][SQ_F1]   += make_score(-30, 0);
  psq[W_KNIGHT][SQ_H4] += make_score( 10, 0);

  psq[B_PAWN][SQ_A3]   += make_score( 19, 0);
  psq[B_KING][SQ_F8]   += make_score( 30, 0);
  psq[B_KNIGHT][SQ_H5] += make_score(-10, 0);
