...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn - we use asymmetrical PSQT for this as there can be big differences between kingside and queenside.
   { S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0), S(  0,  0) },
   { S( -3,-10), S(  3, -4), S( 12, -4), S( 20, -4), S( 16, 13), S( 13,  7), S(  5,  7), S( -5,-16) },
   { S(-15,  0), S(-14, -4), S( 19, -5), S( 27,  0), S( 26, -6), S( 30,  2), S(  2,  2), S(-29, -3) },
   { S(-10,  6), S(-16,  6), S( 16,-11), S( 20,  2), S( 30, -5), S( 18,-10), S( -6,  1), S(-16, -5) },
   { S(  4, 15), S(  4,  7), S( -5,  3), S(  2, -5), S(  9,-17), S( -6, -2), S(-16,  9), S( -7, 10) },
   { S(-10, 29), S(-17, 21), S(  6, 13), S(  8, 11), S( -7, 20), S( -2,  3), S( -8, -1), S(-10, 12) },
   { S(-10,  1), S(  7, -8), S( -5, 13), S( -8, 27), S( -7, 11), S( -9, 10), S( 16, -8), S( -9,  2) }
  };
